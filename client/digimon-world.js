...
export const evolutionRequirements = {
  "Agumon": { hp: 10, mp: 10, off: 1, care: [0, Infinity], weight: [10, 20], partner: 'Koromon' },
  "Betamon": { hp: 10, mp: 10, def: 1, care: [0, Infinity], weight: [10, 20], partner: 'Tanemon' },
  "Biyomon": { mp: 10, def: 1, speed: 1, care: [0, Infinity], weight: [10, 20], partner: 'Tokomon' },
  "Elecmon": { hp: 10, off: 1, speed: 1, care: [0, Infinity], weight: [10, 20], partner: 'Tsunomon' },
  "Gabumon": { def: 1, speed: 1, brains: 1, care: [0, Infinity], weight: [10, 20], partner: 'Koromon' },
  "Kunemon": { special: "50% chance after sleeping in Kunemon's Bed" },
  "Palmon": { mp: 10, speed: 1, brains: 1, care: [0, Infinity], weight: [10, 20], partner: 'Tanemon' },
  "Patamon": { hp: 10, off: 1, brains: 1, care: [0, Infinity], weight: [10, 20], partner: 'Tokomon' },
  "Penguinmon": { mp: 10, def: 1, brains: 1, care: [0, Infinity], weight: [10, 20], partner: 'Tsunomon' },
  "Airdramon": { mp: 1000, speed: 100, brains: 100, care: [0, 1], weight: [25, 35], discipline: 90, techs: 35 },
  "Angemon": { mp: 1000, brains: 100, care: [0, 0], weight: [15, 25], techs: 35, partner: 'Patamon' },
  "Bakemon": { mp: 1000, care: [3, Infinity], weight: [15, 25], happiness: 50, techs: 28 },
  "Birdramon": { speed: 100, care: [3, Infinity], weight: [15, 25], techs: 35, partner: 'Biyomon' },
  ...
  "Kabuterimon": { hp: 1000, mp: 1000, off: 100, speed: 100, care: [0, 1], weight: [25, 35], techs: 35, partner: 'Kunemon' },
  "Kokatorimon": { hp: 1000, care: 3, weight: [25, 35], techs: 28, partner: 'Biyomon' },
  "Kuwagamon": { hp: 1000, mp: 1000, off: 100, speed: 100, care: 5, weight: [25, 35], techs: 28, partner: 'Kunemon' },
  ...
  "Shellmon": { hp: 1000, def: 100, care: 5, weight: [35, 45], techs: 35, partner: 'Betamon' },
